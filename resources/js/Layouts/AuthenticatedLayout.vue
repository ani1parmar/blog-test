...
<template>
    <div class="antialiased bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white">
        <nav
            ...
            <div class="flex flex-wrap justify-between items-center">
                ...
                <div class="flex items-center lg:order-2">
                    ...
                    <div
                        ...
                        class="absolute top-16 right-0 z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                        id="dropdown"
                    >
                        <div class="py-3 px-4">
              <span
